    ...
    in concatStrings [''
      ...
      follow_mouse = 1
            ...
            # env = NIXOS_OZONE_WL, 1
             ...
             env = XCOMPOSEFILE,/home/andre/.XCompose       # se usa .XCompose próprio
             env =    GTK_IM_MODULE,cedilla      # força GTK a respeitar Compose/locale
             env =  QT_IM_MODULE,cedilla           # opcional; ou deixe vazio se não usa Qt
             ...
             exec-once = swww img ${userSettings.wallpaperDir}/battery-gruvbox.png
             exec-once = waybar
             exec-once = swaync
