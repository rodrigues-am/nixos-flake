{ pkgs, config, lib, nix-colors, userSettings, ... }:

let
  theme = config.colorScheme.colors;
  wallpaperDir = userSettings.wallpaperDir;
in with lib; {
  wayland.windowManager.hyprland = {
    ...
    in concatStrings [''
           ...
           # exec-once = $POLKIT_BIN
            ...
            exec-once = swww init
            exec-once = swww img ${userSettings.wallpaperDir}/01.jpg
            exec-once = waybar
            exec-once = swaync
            ...
            bind = ${modifier}SHIFT,F,exec,naltilus
      ...
      #     bind = ${modifier}SHIFT,G,exec,godot4
            ...
            bind = ${modifier}SHIFT,W,togglefloating,
