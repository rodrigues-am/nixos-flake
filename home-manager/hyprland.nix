...
in with lib; {
  ...
  wayland.windowManager.hyprland = {
    ...
    in concatStrings [''
      ...
      binde=${modifier}CTRL,right,resizeactive,250 0
      binde=${modifier}CTRL,left,resizeactive,-250 0
      binde=${modifier}CTRL,up,resizeactive,0 -250
      binde=${modifier}CTRL,down,resizeactive,0 250
