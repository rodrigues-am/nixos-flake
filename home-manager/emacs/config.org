...
#+RESULTS:
| t | task inbox | entry | (file+headline ~/notas/general/inbox.org Inbox)    | (file ~/sync/pessoal/emacs/org-capture-templates/inbox.org) |
| b | blog post  | entry | (file+headline ~/notas/blog/blog.org NO New ideas) | (file ~/sync/pessoal/emacs/org-capture-templates/post.org)  |
